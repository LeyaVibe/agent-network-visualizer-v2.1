        ...
        <div>
          ...
          <div className="mt-4">
            <div className="flex items-center gap-2 mb-2">
              <h5 className="text-sm font-medium text-gray-700">Распределение мнений</h5>
              <Tooltip>
                <TooltipTrigger asChild>
                  <span className="cursor-help text-gray-500 text-xs">ⓘ</span>
                </TooltipTrigger>
                <TooltipContent className="max-w-xs bg-gray-900 text-white">
                  <p>Мнения от -1 до +1: Негативные (&lt; -0.2), Нейтральные (-0.2 до 0.2), Позитивные (&gt; 0.2)</p>
                </TooltipContent>
              </Tooltip>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div className="text-xs text-gray-600 mt-1">(-0.2 до 0.2)</div>
              </div>
