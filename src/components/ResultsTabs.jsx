          ...
          <div ref={summaryRef} className="space-y-6">
                ...
                <div className="text-sm text-purple-800 flex items-center gap-1">
                  ...
                  <Tooltip>
                    <TooltipTrigger asChild>
                      <span className="cursor-help text-purple-600">ⓘ</span>
                    </TooltipTrigger>
                    <TooltipContent className="max-w-xs bg-gray-900 text-white">
                      <p>Процент активных связей от всех возможных связей между агентами (0% = нет связей, 100% = все связаны со всеми)</p>
                    </TooltipContent>
                  </Tooltip>
                </div>
              </div>
            ...
            <div>
              <h4 className="text-lg font-medium mb-4 flex items-center gap-2">
                Статистика по кластерам связей
                <Tooltip>
                  <TooltipTrigger asChild>
                    <span className="cursor-help text-gray-500 text-sm">ⓘ</span>
                  </TooltipTrigger>
                  <TooltipContent className="max-w-xs bg-gray-900 text-white">
                    <p>Замкнутость: процент внутренних связей от всех связей кластера (0% = все связи внешние, 100% = все связи внутренние)</p>
                  </TooltipContent>
                </Tooltip>
              </h4>
              ...
              <div>
                <h4 className="text-lg font-medium mb-4 flex items-center gap-2">
                  ...
                  <Tooltip>
                    ...
                    <TooltipContent className="max-w-xs bg-gray-900 text-white">
                      <p>Мнения агентов по темам: от -1 (полностью против) через 0 (нейтрален) до +1 (полностью за)</p>
                    </TooltipContent>
                  </Tooltip>
                </h4>
